/**
 * Catalog of cognitive profiles.
 *
 * Each profile describes a CONSTRAINED COGNITIVE PROCESS (never a lack of
 * intelligence). These fragments feed the system prompts of the student-agents.
 * Pure data — no runtime dependency.
 */
import type { Level, Style } from "../value-objects/axes";
