...
import { buildMarkdown, buildPrintableHtml, exportFilename } from "@/classroom/adapters/export/markdown-dossier";
import { dossierPdf, evaluationsPdf, exercisesPdf, sheetPdf, lessonPdf, savePdf } from "@/classroom/adapters/export/pdf-dossier";
import type { FactCheckReport } from "@/classroom/domain";
        ...
        <Panel title="Diagnosis">
          ...
          <ul style={ul}>
            {diagnosis.ambiguous_passages.map((p, i) => (
              <li key={i}>
                &ldquo;{p.excerpt}&rdquo; — {p.problem}
              </li>
            ))}
          </ul>
